    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Y', '요가'), ('P', '필라테스')], default='Y', max_length=1, verbose_name='클래스 종류')),
                ('theme', models.CharField(choices=[('1', '임산부'), ('2', '키즈')], default='1', max_length=1, verbose_name='수업 테마')),
                ...
                ('price', models.IntegerField(help_text='단위: 원', verbose_name='비용')),
